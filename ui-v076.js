// Ashen Voice Studio v0.8.6 — UI truthfulness patch
(function(){
  ...
  function syncLabels(){
    queued=false;
    const v=document.querySelector('.version');if(v&&v.textContent!=='v0.8.6')v.textContent='v0.8.6';
    ...
    if(castHead)castHead.textContent='Preset, designed, true embedding blend, or browser-native Reference Voice per character.';
    document.querySelectorAll('.modeTab[data-mode="clone"]').forEach(b=>b.textContent='Reference');
