// Ashen Voice Studio v0.7.8 — UI truthfulness patch
(function(){
  ...
  function syncLabels(){
    queued=false;
    const v=document.querySelector('.version');if(v&&v.textContent!=='v0.7.8')v.textContent='v0.7.8';
    ...
    if(castHead)castHead.textContent='Preset, designed, true embedding blend, or cloned voice per character.';
